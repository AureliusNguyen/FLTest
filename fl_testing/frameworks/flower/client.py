...
class FlowerClient(NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        train(self.net, self.trainloader, epochs=self.cfg.client_epochs, device=self.cfg.device, loss_fn=self.cfg.loss_fn, opitmzer_name=self.cfg.optimizer, seed=self.cfg.seed)
